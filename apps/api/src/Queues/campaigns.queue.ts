...
if (existingJob) {
  ...
  /*
   * Existing live job ko remove/recreate nahi karte.
   * Same deterministic job ID campaign ko duplicate
   * queue hone aur scheduled delay reset hone se rokta hai.
   */
  ...
  /*
   * Completed or failed historical job ko remove karke
   * same campaign ke valid next batch/retry ko add karte hain.
   */
